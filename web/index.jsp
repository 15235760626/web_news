                        ...
                        <div class="datas">
                            <ul>
                                <%
                                    ...
                                    if (newslist.get(0).getPyteId()==typeList.get(i).getTypeId())
                                        for (News news:newslist) {
                                            String date = DateUtil.formatDate(news.getPubishDate(), "yyyy-MM-dd");
